...
| `tasks.clean_dirs` | Dirs to clean before each hook (worktree caches) | `[]` |
| **Quality Hooks** | | |
...
| `parallel.symlink_dirs` | Dirs to symlink from main workspace into worktrees | `[]` |
| **Convergence** | | |
...
| **Contract** | | |
| `contract.enabled` | Enable sprint contract negotiation before each task | `false` |
